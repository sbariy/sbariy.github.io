...
<div class="periodical-instances-search">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                    <!-- Дата от/до -->
                    <div class="row">
                        <div class="col-xs-6"><?= $form->field($model, 'publication.releasedFrom')->widget(Select2::classname(), [
                        ...
                        <div class="col-xs-6"><?= $form->field($model, 'publication.releasedTo')->widget(Select2::classname(), [
                                'data' => array_reverse(array_combine(range(1700, date('Y')), range(1700, date('Y'))), true),
                                'showToggleAll' => false,
                                'size' => Select2::SMALL,
                                'options' => [
    ...
    <div class="row">
        <div class="col-md-6">
            <?= $form->field($model, 'publication.isbn', [
                'options' => ['class' => 'input-group-sm'],
            ]); ?>
        </div>
    ...
    <?= $form->field($model, 'publication.bbk', [
        'options' => ['class' => 'input-group-sm'],
    ]) ?>
