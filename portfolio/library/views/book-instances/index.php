...
<div class="publication-instance-index">
    ...
    <div class="buttons-grid-view">
        <?= Html::button('Добавление издания '.Html::tag('span', '', ['class' => 'glyphicon glyphicon-plus']), ['class' => 'btn btn-primary btn-dialog-create-publication', 'url-pjax' => 'book/create']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'attribute' => 'publication.author.initials',
                'format' => 'raw',
                'value' => function($model, $key, $index, $column) {
                    return $model->publication->authorsToString;
                }
            ],
            'price',
            [
