...
<div class="publication-instance-view">
        ...
        <div class="col-md-4 body-attribute">
            <table class="body-attribute">
                <tr>
                    ...
                    <td><?= $model['publication']['isbn'] ?: '--' ?></td>
                </tr>
                <tr>
                    <th><span>ББК:</span></th>
                    <td><?= $model['publication']['bbk'] ?: '--' ?></td>
                </tr>
                <tr>
    ...
    <br>
    <div class="row">
        <div class="col-md-5 body-attribute body-attribute-block">
            <?= Html::tag('h4', 'Авторы') ?>
            <div class="body-attribute-block"><?= $model['publication']['authorsToString'] ?></div>
        </div>
        <div class="col-md-7 body-attribute body-attribute-block">
